...
import { generateEditedImage, generateFilteredImage, generateAdjustedImage, generateRemovedBgImage } from './services/geminiService';
...
type Tab = 'retouch' | 'adjust' | 'filters' | 'crop' | 'remove-bg';

const TABS: { id: Tab; label: string }[] = [
  { id: 'retouch', label: 'Retocar' },
  { id: 'remove-bg', label: 'Remover Fundo' },
  { id: 'crop', label: 'Cortar' },
...
const App: React.FC = () => {
  ...
  const handleRemoveBackground = useCallback(async () => {
    ...
    try {
        const removedBgImageUrl = await generateRemovedBgImage(currentImage);
